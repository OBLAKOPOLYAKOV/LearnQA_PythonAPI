...
Наша задача написать параметризированный тест. Этот тест должен брать из дата-провайдера User Agent
и ожидаемые значения, GET-делать запрос с этим User Agent и убеждаться, что результат работы нашего метода
...
"""
https://github.com/OBLAKOPOLYAKOV/LearnQA_PythonAPI/commit/78f3d0c2538d4759ef7a22eb0ca3218a727d0c8c

Неправильные User agent:
user_agents = 'Mozilla/5.0 (iPad; CPU OS 13_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/91.0.4472.77 Mobile/15E148 Safari/604.1' : Cannot find browser:'Chrome' in the response_browser: No
user_agents = 'Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)': Cannot find platform:'Googlebot' in the response_platform: Unknown
user_agents = 'Mozilla/5.0 (iPad; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1': Cannot find device:'iPhone' in the response_device:Unknown
"""
